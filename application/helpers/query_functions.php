<?php
  ...
  function validate_admin($admin, $options=[]) {
    ...
    if(is_blank($admin['email'])) {
      ...
      $errors['email'] = "Email name must be less than 255 characters.";
    ...
    if(is_blank($admin['username'])) {
      ...
      $errors['username'] = "Username must be between 8 and 255 characters.";
    } 
    // elseif (!has_unique_username($admin['username'], $admin['id'] ?? 0)) {
    //   $errors['username'] = "Username not allowed. Try another.";
    // }

								...
								<div class="col-md-12 col-lg-12 col-xl-12">
									...
									<form method="post" enctype="multipart/form-data">
										<div class="row">
											...
											<!-- <div class="form-group col-4">
												<label>Heading</label>
												<input name="heading" type="text" class="form-control" placeholder="ex. Timber Cutting Skills">
											</div> -->
											<div class="form-group col-4">
											...
											<!-- <div class="form-group col-12">
												<label>Video</label>
												<textarea name="video" class="form-control" id="editor3" ></textarea>
											</div> -->
											<!-- <div class="form-group col-4">
												<label>Skill Link</label>
												<input name="skill_link" type="text" class="form-control" placeholder="ex. Timber_Cutting">
											</div> -->
											<div class="form-group col-12">

			...
			<div class="row align-items-center">
								...
								<div class="sign2">
									<div class="card">
										<div class="card-body mt-2 mb-2 p-5">
											...
											<img src="<?= base_url('assets/admin/logo.png') ?>" class="header-brand-img desktop-logo text-left mb-5 theme-logo" alt="logo">
											...
											<form method="post">
												...
												<div class="row">
													...
													<div class="col-12 mt-3">
														<button type="submit" formaction="<?= base_url(this_link . 'do_login') ?>" class="btn btn-primary rounded-11 btn-block">SIGN IN</button>
													</div>
											...
											<!-- <div class="coming-form d-flex text-center justify-content-center mt-4">
												<div class="coming-form1 mr-4">
													<a href="#">
														<i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook">
												...
												<div class="coming-form1 mr-4">
													<a href="#">
														<i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-twitter">
												...
												<div class="coming-form1">
													<a href="#">
														<i><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram">
				...
				<div class="col-md-12 col-xl-6 d-md-block d-none wrapper-3 signinwrap">
					<div class="my-auto mx-auto">
						...
						<a href="<?= base_url('admin-registration') ?>" class="btn  wd-150 text-white btn-md  btn-outline-primary rounded-11 disabled">Sign Up</a>
					</div>
				</div>

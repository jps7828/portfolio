						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-hover text-nowrap text-md-nowrap table-striped mg-b-0s">
									...
									<tbody>
										<?php $i=1; foreach ($social_network_view as $row): ?>
										<tr>
											<td><?= $i++ ;?></td>
											<td><?= $row->social_network_name; ?></td>
											<td><?= $row->social_network_icon; ?></td>
											<td><?= $row->social_network_link; ?></td>
											<td><?= $row->social_network_status; ?></td>
											<td> 
												<a href="javascript:;" onclick="edit('<?= $row->social_network_id ?>')" class="btn btn-outline-info btn-sm rounded-11 mr-2"> <i class="fe fe-edit-2"></i> </a>
												<a href="javascript:;" onclick="delete_data('<?= $row->social_network_id?>')" class="btn btn-outline-danger btn-sm rounded-11 mr-2"> <i class="fe fe-trash-2"></i> </a>
											</td>
										</tr>
										<?php endforeach ?>
									</tbody>

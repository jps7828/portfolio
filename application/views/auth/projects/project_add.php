									...
									<form method="post" enctype="multipart/form-data">
										<div class="row">
											...
											<div class="form-group col-4">
												...
												<input name="project_link" type="text" class="form-control" placeholder="ex. Timber_Cutting">
											</div>
											<div class="form-group col-4">
												<label>Project Connecting Link</label>
												<input name="link" type="text" class="form-control" placeholder="ex. Project/index/Timber_Cutting">
											</div>
											<div class="form-group col-12">

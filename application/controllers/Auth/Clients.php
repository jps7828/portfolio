...
define('this_controller', 'Clients');
define('this_view', 'auth/clients/clients');
define('this_asset', web_url . 'assets/admin/');
define('this_link', 'Auth/Clients/');
define('this_table', 'clients');
...
class Clients extends Admin_Controller {
	...
	public function insert()
	{
        ...
        if ($_FILES['image_1']['name']!="") {
			$image_1 = image_validation('clients', 'image_1');
		...
		[ 
			...
			'clients_image_1' => $image_1,
			// 'clients_caption' => $this->input->post('caption'),
			'clients_status' => $this->input->post('status')
		];
	...
	public function update($id)
	{
		...
		if ($_FILES['image_1']['name']!="") 
		{
            // $image_1 = $this->file_upload_img('clients', 'image_1');
            // if($image_1 === false) {
            // set_msg('File upload failed. Try Again!!', 'E');
            // refer();
